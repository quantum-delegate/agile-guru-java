package com.quantumofvalue.java.agileguru.cucumber.features.stepdefinitions;
...
public class WalkingSkeletonSteps {
	...
	public void items_and_in_the_database(String item1, String item2)
		...
		Assert.assertArrayEquals(items.toArray(), itemService.findAll()
				.toArray());
	}
	...
	public void I_should_see_and_listed_on_the_page(String item1, String item2)
			throws Throwable {
		List<WebElement> tdElements = driver.findElements(By
				.xpath("//td[@class='item_text']"));
		List<String> stringElements = transform(tdElements,
				new Function<WebElement, String>() {
					public String apply(WebElement webElement) {
						return webElement.getText();
					}
				});
		Assert.assertArrayEquals(new String[] { item1, item2 },
				stringElements.toArray());
	}
